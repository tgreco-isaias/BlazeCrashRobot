...
namespace BlazeCrashRobot
{
    public static class WebView2Extends
    {
        ...
        public static double GetCrashY(this WebView2 webView)
        {
            return Convert.ToDouble(webView.ExecutarScript("crash_y").ToString()
                , new CultureInfo("en-US") { NumberFormat = new NumberFormatInfo() { NumberDecimalSeparator = "." } });
        }
